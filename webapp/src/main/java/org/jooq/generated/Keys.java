...
public class Keys {
    ...
    public static final UniqueKey<CustomCommandsRecord> CUSTOM_COMMANDS_PKEY = Internal.createUniqueKey(CustomCommands.CUSTOM_COMMANDS, DSL.name("custom_commands_pkey"), new TableField[] { CustomCommands.CUSTOM_COMMANDS.ROBOT_ID, CustomCommands.CUSTOM_COMMANDS.COMMAND_TYPE }, true);
    ...
    public static final ForeignKey<CustomCommandsRecord, RobotsRecord> CUSTOM_COMMANDS__CUSTOM_COMMANDS_ROBOT_ID_FKEY = Internal.createForeignKey(CustomCommands.CUSTOM_COMMANDS, DSL.name("custom_commands_robot_id_fkey"), new TableField[] { CustomCommands.CUSTOM_COMMANDS.ROBOT_ID }, Keys.ROBOTS_PKEY, new TableField[] { Robots.ROBOTS.ROBOT_ID }, true);
